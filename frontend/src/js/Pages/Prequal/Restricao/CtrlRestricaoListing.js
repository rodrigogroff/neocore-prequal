...
import MyForm from "./ViewRestricaoListing"
...
export default class {
  ...
  constructor() {
    ...
    function search() {
      ...
      getPrequalTokenPortal(Endpoints().prequal_enums_tipoRestricao, "")
        .then((resp) => {
    ...
    document.body.addEventListener("click", (e) => {
      ...
      switch ($(e.target).attr("id")) {
        ...
        case elements.btnAtualizarItem:
          postPrequalTokenPortal(Endpoints().prequal_enums_tipoRestricao, {
