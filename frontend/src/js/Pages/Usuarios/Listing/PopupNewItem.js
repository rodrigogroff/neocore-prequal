...
<div class="popup-container" style='margin-top:50px;max-width:875px;z-index:1;height:430px' align='center'>
  <div class="popup-header">
    <h3 style='padding-left:32px;color:black' class="popup-title" id='popUpSystemNewItem'>
      Novo usuário para CCP backoffice
    </h3>
    ...
    <br>
      <table width='700px' align='center' style='font-weight:bold'>
        ...
        <tr>
          ...
          <td colspan='4'>
            <input id="${elements.formNewItem_Email}">
          </td>          
        </tr>
        <tr>
          <td>Nome do usuário</td>
          <td colspan='4'>
            <input id="${elements.formNewItem_Nome}">
          </td>          
        </tr>        
        <tr>
          <td>Área do usuário</td>
          <td colspan='4'>
            <input id="${elements.formNewItem_Area}">
          </td>          
        </tr>   
      </table>
      <br>
      ...
      <br><br><br>
      <div align='center'>
        <a id="${elements.btnCriarItem}" class="button red">Criar Usuário</a>
      </div>
      <br><br>      
    </div>
  </div>
